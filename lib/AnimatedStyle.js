...
for(var key in this._style){
var value=this._style[key];
if(value&&typeof value==='object'&&'__getAnimatedValue'in value){
...
for(var key in this._style){
var value=this._style[key];
if(value&&typeof value==='object'&&'__addChild'in value){
...
for(var key in this._style){
var value=this._style[key];
if(value&&typeof value==='object'&&'__removeChild'in value){
